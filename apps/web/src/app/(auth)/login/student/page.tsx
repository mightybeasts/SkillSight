...
export default function StudentLoginPage() {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="relative hidden w-1/2 overflow-hidden bg-student-gradient lg:block">
        {/* Floating shapes */}
        <div className="float-shape left-[10%] top-[15%] h-64 w-64 bg-white" />
        <div className="float-shape right-[15%] top-[40%] h-48 w-48 bg-blue-300" />
        <div className="float-shape left-[30%] bottom-[10%] h-32 w-32 bg-blue-200" />
        ...
        <div className="relative z-10 flex h-full flex-col justify-between p-12">
          ...
          <div className="max-w-md">
            <h2 className="mb-4 text-4xl font-bold leading-tight text-white">
              Your career,<br />AI-powered
            </h2>
            <p className="text-lg text-blue-100/80">
              Upload your resume once. Get matched to jobs that truly fit your skills —
              with transparent scores and personalized growth paths.
            </p>
      ...
      <div className="flex w-full flex-col justify-center bg-[#f8f9fb] px-6 lg:w-1/2 lg:px-20">
        <div className="mx-auto w-full max-w-md">
          ...
          <div className="mb-8 flex items-center gap-2 lg:hidden">
            <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-student-600">
          ...
          <div className="mb-2 inline-flex items-center rounded-full bg-student-50 px-3 py-1 text-xs font-medium text-student-700">
            Student / Job Seeker
          </div>
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-xl border-2 border-dashed border-student-200 bg-student-50 px-6 py-4 text-base font-medium text-student-700 transition hover:border-student-400 hover:bg-student-100"
          >
            <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
            </svg>
            Demo Login as Aisha Khan (Student)
          </button>
          ...
          <div className="space-y-3">
            {[
              { icon: '🎯', text: 'AI job matching with transparent scores' },
              { icon: '📊', text: 'Skill gap analysis & learning recommendations' },
              { icon: '📄', text: 'Auto-generate role-specific resumes' },
              { icon: '🚀', text: 'Track applications & interview readiness' },
            ].map((feature) => (
